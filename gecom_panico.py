# =============================================
# GECOM SEGURANÇA — BOTÃO DE PÂNICO DO CLIENTE
# =============================================
# Instale: pip install streamlit pywhatkit geopy psycopg2-binary
...
# =============================================
DB_CONFIG = {
    "dbname": "gecom_monitoramento",
    "user": "postgres",
    "password": "sua_senha_aqui",  # ← TROQUE pela sua senha
    "host": "localhost",
    "port": 5432
}

WHATSAPP_ATIVO = True
WHATSAPP_NUMERO_CENTRAL = "+5551999999999"  # ← SEU NÚMERO
